...
print("Para imprimir la forma del array:", array1.shape, array2.shape)

print('\nsuma de listas:', lista1 + lista2)
...
print('\ndivision por array', arr_1/arr_2)

print('division por constante', arr_1/2)

print('divsion constante sobre array', 10/arr_1)

print('\npotencia de array', arr_2**2)

print('\nraiz de array', arr_2**(0.5))

print('\npotencia de array con "numeros negativos"', 1/arr_2**2)
